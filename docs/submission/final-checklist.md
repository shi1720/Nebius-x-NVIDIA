...
- **YouTube title and description:** `youtube.md`; public video: https://www.youtube.com/watch?v=J0Gy2FWsm-M.
...
- [x] Complete responsive browser testing, sign-in, private upload, persistence, evidence review, export and sign-out on the deployed application.
- [x] Create a usable Nebius credential, verify `nvidia/nemotron-3-super-120b-a12b` and pass `npm run test:live` on `sunward-v1`.
- [x] Record hosted upload, real Nebius extraction, reviewed import, reload, two evidence decisions and verified exports. Retain `docs/evaluation/hosted-nebius.json`.
